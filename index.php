...
<ul>
  ...
  <li><img onclick="changeEng()"src="img/eng.png" style="cursor: pointer; margin:12px 0 0 750px; height:20px; "></img></li>
  <li><img onclick="changeInd()" src="img/ina.jpg" style="cursor: pointer; margin:7px 0 0 800px; margin-top:-40px; height:30px; "></img></li>
	...
	<div id="w">
		<div class="container">
			<div class="row">
				...
				<h3>WE <strong>WORK HARD</strong> TO DELIVER A <strong>HIGH QUALITY SERVICE</strong>. OUR AIM IS YOUR COMPLETE <strong>SATISFACTION</strong>.</h3>
				</div>
			</div>
		</div><!-- /container -->
	</div><!-- /w -->
