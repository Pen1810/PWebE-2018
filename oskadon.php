        ...
        <div class="col-sm-4">
            ...
            <div class="col-sm-10">
                <table>
                    ...
                    <tr>
                        <td>Distributor</td>
                        <td>Republic of BrainWash Syndicate 2</td>
                    </tr>
                    <tr>
                        <td>Garansi</td>
                ...
                <br>
                <br>
                <h3>Efektif untuk mengurangi kepasrahan karena abis praktikum yang bikin pusing (Sisop, Jarkom, dll) dan juga abis tes dan soalnya PASRAH SEMUA. Termasuk dapet KA Zonk</h3>
            </div>
            <div class="col-sm-1"></div>
        </div>
        <div class="col-sm-3">
