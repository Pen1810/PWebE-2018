    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="col-sm-10">
                ...
                <br>
                <br>
                <h3>BrainWasgin BLACK SE. Cocok yang ingin khasiat seperti BrainWasgin BLACK Type R namun dengan dosis yang sedikit disunat supaya dapat mengurangi efek samping</h3>
            </div>
            <div class="col-sm-1"></div>
        </div>
        <div class="col-sm-3">
