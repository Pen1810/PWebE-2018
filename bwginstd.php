        ...
        <div class="col-sm-4">
            ...
            <div class="col-sm-10">
                <table>
                    <tr>
                        <td>Tipe</td>
                        <td>BrainWashgin Green (Standard)</td>
                    </tr>
                    <tr>
                        <td>Berat</td>
                        <td>1kg</td>
                ...
                <br>
                <br>
                <h3>Kesal Di Brainwash jadi Bemper, wibu akut, dll? BrainWashgin aja. Dijamin meskipun teman anda ngeVV didepan mata anda atau ada teman bemper antec juragan malkist ngasih propaganda ke anda DIJAMIN MENTALLLLL</h3>
