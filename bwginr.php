    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="col-sm-10">
                ...
                <br>
                <br>
                <h3>BrainWasgin BLACK Type R. Dengan kekuatan BLACK Formula, DIJAMIN AMPUH 100% menangkal propaganda yang ada. WARNING! ADA EFEK SAMPING, SILAHKAN EMAIL KAMI UNTUK INFO LEBIH LANJUT</h3>
            </div>
            <div class="col-sm-1"></div>
        </div>
        <div class="col-sm-3">
