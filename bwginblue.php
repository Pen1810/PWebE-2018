    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="col-sm-10">
                ...
                <br>
                <br>
                <h3>Dengan kandungan formula yang 2X lebih kuat dibanding BrainWashgin Green, maka obat ini cocok banget untuk menangkal segala propaganda yang ada</h3>
            </div>
            <div class="col-sm-1"></div>
        </div>
        <div class="col-sm-3">
