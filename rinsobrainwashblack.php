        ...
        <div class="col-sm-4">
            ...
            <div class="col-sm-10">
                <table>
                    <tr>
                        <td>Tipe</td>
                        <td>Rinso BrainWash BLACK EDITION</td>
                    </tr>
                    <tr>
                        <td>Berat</td>
                        <td>20kg</td>
                ...
                <br>
                <br>
                <h3>Rinso BrainWash Black. Jika Propaganda yang diberikan oleh seseorang sudah KUAT BANGET dan tidak bisa hilang dengan menggunakan Rinso BrainWash Standar maupun Extra. Pakailah ini, dengan kekuatan 10X konsentrat dan juga R*, dijamin OTAK ANDA LANGSUNG BEBASSSSSSSS DARI PROPAGANDA</h3>
            </div>
            <div class="col-sm-1"></div>
        </div>
        <div class="col-sm-3">
